...
def show_boxes(idx, save=True):
    ...
    img = cv2.imread('./train_test_data/kpt_local/test/images/{}'.format(image_filename))
    vis = img.copy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--num', type=int, default=len(os.listdir('./train_test_data/kpt_local/test/images')) - 1)
