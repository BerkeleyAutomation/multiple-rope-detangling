...
def show_kpts(idx, image_dir):
    ...
    img = cv2.imread('train_test_data/kpt_yellow_cropped/test/images/{}'.format(image_filename))
    vis = img.copy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dir', type=str, default='train_test_data/kpt_yellow_cropped/test/keypoints')
