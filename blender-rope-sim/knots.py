...
def flip_pretzel_knot(params, chain=False, render=False):
    end_frame = tie_loose_pretzel(params, render=True)
    return flip(params, end_frame)

def flip(params, start_frame):
    piece = "Cylinder"
    last = params["num_segments"]-1
    end2 = get_piece(piece, last)
...
def tie_double_pretzel(params, chain=False, render=False):
    ...
    take_action(end2, 535, (11,0,-2))
    take_action(end1, 535, (18,-3,-2))
