...
keypoints.load_state_dict(torch.load('checkpoints/vanilla_hulk_segmented/model_2_1_2_0.0035196005673935327.pth'))
...
image_dir = 'data/train_sets/reid_two_rope/test/images'
