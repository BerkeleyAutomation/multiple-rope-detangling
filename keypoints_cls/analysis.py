...
keypoints.load_state_dict(torch.load('checkpoints/conditioned_all_cases/model_2_1_20_1.0030643083971575.pth'))
...
#image_dir = 'data/real_images/rollouts2'

data_dir = "real_images/test_cases"
