...
keypoints.load_state_dict(torch.load('checkpoints/term_zoom_mask/model_2_1_24_0.016701355239523076.pth'))
...
image_dir = 'data/train_sets/term_zoom_mask/test/images'
