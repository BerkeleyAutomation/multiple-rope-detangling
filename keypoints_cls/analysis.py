...
keypoints.load_state_dict(torch.load('checkpoints/reid_select/model_2_1_2_0.003070000897991516.pth'))
...
image_dir = 'data/real_images/real_color_rope_cond/images'
